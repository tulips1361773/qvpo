        ...
        for itr in range(iterations):
            ...
            if t % self.policy_freq == 0:
                ...
                if self.policy_type == 'Diffusion' and self.weighted:
                    ...
                    # solu4: 注释掉 q clamp，让 q_transform 自然工作
