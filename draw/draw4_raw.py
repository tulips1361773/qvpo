...
show_title = False
strict_missing_files = False   # TD3 的 seed101 / final 缺失时建议 False

# 坐标轴范围
xlim = (0.0, 1.0)
ylim_reward = (-60, 50)
ylim_leakage = (0.0, 1.0)
...
# final 图论文风格设置
final_title_fontsize = 12
final_label_fontsize = 12
final_tick_fontsize = 11

final_subplot_titles = {
    "final_eval_reward": "(a) Final Reward",
    "final_leakage_rate": "(b) Final Leakage Rate",
    "final_legal_snr_db": "(c) Final Legal SNR",
}

# TD3 final 图使用占位符
final_placeholder_algorithms = {"TD3"}
placeholder_facecolor = "#E6E6E6"
placeholder_edgecolor = "#888888"
placeholder_hatch = "//"
placeholder_text = "N/A"
placeholder_text_size = 11
...
def plot_final_metric_comparison(
    ...
    metrics = [
        ...
        ("final_leakage_rate", "Final Leakage Rate"),
        ("final_legal_snr_db", "Final Legal SNR (dB)"),
    ]
...
if __name__ == "__main__":
    ...
    plot_eval_metric_curves(
        ...
        ylabel="Evaluation Leakage Rate",
