...
save_fig = True
save_dir = "./figures_chinese_newcolor"
...
def plot_eval_metric_curves(
    ...
    if save_fig:
        ...
        svg_path = os.path.join(save_dir, f"{save_stem}.svg")
...
def plot_final_metric_comparison(
    ...
    for ax, (metric_key, ylabel) in zip(axes, metrics):
        ...
        # 先画网格，让柱子盖在上面
        ax.grid(True, axis="y", linestyle="--", alpha=0.10, zorder=0)
        ...
        for i, algo_name in enumerate(algo_names):
            if placeholder_mask[i]:
                ...
                ax.bar(
                    ...
                    edgecolor=final_edge_color_map[algo_name],
                    linewidth=2,
